	...
	<body>
		...
		<form:form method="POST" commandName="customerForm">
			...
			<table>
				...
				<tr>
					<td>Subscribe to newslettter? :</td>
					<td><form:checkbox path="receiveNewsletter"/></td>
					<td><form:errors path="receivedNewsletter" cssClass="error"/></td>				
				</tr>				
				<tr>
				...
				<tr>
					<td>Sex :</td>
					<td><form:radiobutton path="sex" value="M"/></td>
				...
				<tr>
					<td>Java Skills :</td>
					<td><form:select path="javaSkills" items="${javaSkillList}" multiple="true"/></td>
